  ...
  return (
    <section className="bg-white py-16 md:py-24" id="media">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Media Logos */}
        <AnimateOnScroll animation="fade-in" delay={200} duration={600}>
        ...
        {/* News Section */}
        <AnimateOnScroll animation="fade-in-up" delay={100} duration={600}>
        ...
        {/* News Cards */}
        <div className="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto overflow-y-hidden md:overflow-visible snap-x snap-mandatory md:snap-none scroll-smooth -mx-4 px-4 md:mx-0 md:px-0 pb-2 md:pb-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
