        ...
        <div className="bg-[#1C1C1C] rounded-3xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="min-w-0 p-8 md:p-12 lg:p-14 flex flex-col justify-center">
              <h2 className="text-2xl md:text-3xl lg:text-[34px] font-bold text-white leading-tight mb-6">
                Konsultasikan <span className="text-[#FFD54F] font-extrabold">kebutuhan bisnis</span> anda
                bersama praktisi yang telah mendampingi
                berbagai <span className="text-[#FFD54F] font-extrabold">perusahaan, institusi, dan organisasi</span> di Indonesia.
              </h2>
            ...
            {/* Right - Form */}
            <div className="min-w-0 bg-white p-8 md:p-10 lg:p-12 rounded-t-3xl md:rounded-t-none md:rounded-r-3xl flex flex-col justify-center py-8 md:py-10">
              {isSuccess ? (
