...
// Derives the flag emoji from an ISO 3166-1 alpha-2 code
// (regional indicator symbols are offset from ASCII letters by 0x1F1E6 - 'A')
export function flagEmoji(iso2: string): string {
  return iso2
    .toUpperCase()
    .replace(/./g, (char) => String.fromCodePoint(char.charCodeAt(0) + 0x1f1e6 - 65));
}
...
export const countries: Country[] = [
  ...
  { name: 'Filipina', iso2: 'PH', dial: '63' },
  { name: 'Kamboja', iso2: 'KH', dial: '855' },
  ...
  { name: 'Aljazair', iso2: 'DZ', dial: '213' },
  { name: 'Amerika Serikat', iso2: 'US', dial: '1' },
  { name: 'Andorra', iso2: 'AD', dial: '376' },
  { name: 'Angola', iso2: 'AO', dial: '244' },
  { name: 'Arab Saudi', iso2: 'SA', dial: '966' },
  ...
  { name: 'Dominika', iso2: 'DM', dial: '1767' },
  { name: 'Ekuador', iso2: 'EC', dial: '593' },
  ...
  { name: 'Guinea Khatulistiwa', iso2: 'GQ', dial: '240' },
  { name: 'Guyana', iso2: 'GY', dial: '592' },
  { name: 'Haiti', iso2: 'HT', dial: '509' },
  { name: 'Honduras', iso2: 'HN', dial: '504' },
  { name: 'Hong Kong', iso2: 'HK', dial: '852' },
  { name: 'Hongaria', iso2: 'HU', dial: '36' },
  { name: 'India', iso2: 'IN', dial: '91' },
  { name: 'Inggris', iso2: 'GB', dial: '44' },
  { name: 'Irak', iso2: 'IQ', dial: '964' },
  { name: 'Iran', iso2: 'IR', dial: '98' },
  { name: 'Irlandia', iso2: 'IE', dial: '353' },
  { name: 'Islandia', iso2: 'IS', dial: '354' },
  { name: 'Israel', iso2: 'IL', dial: '972' },
  { name: 'Italia', iso2: 'IT', dial: '39' },
  { name: 'Jamaika', iso2: 'JM', dial: '1876' },
  { name: 'Jepang', iso2: 'JP', dial: '81' },
  { name: 'Jerman', iso2: 'DE', dial: '49' },
  { name: 'Kamerun', iso2: 'CM', dial: '237' },
  { name: 'Kanada', iso2: 'CA', dial: '1' },
  { name: 'Kazakhstan', iso2: 'KZ', dial: '7' },
  { name: 'Kenya', iso2: 'KE', dial: '254' },
  { name: 'Kirgizstan', iso2: 'KG', dial: '996' },
  { name: 'Kolombia', iso2: 'CO', dial: '57' },
  { name: 'Komoro', iso2: 'KM', dial: '269' },
  { name: 'Republik Kongo', iso2: 'CG', dial: '242' },
  { name: 'Republik Demokratik Kongo', iso2: 'CD', dial: '243' },
  { name: 'Korea Selatan', iso2: 'KR', dial: '82' },
  { name: 'Korea Utara', iso2: 'KP', dial: '850' },
  { name: 'Kosta Rika', iso2: 'CR', dial: '506' },
  { name: 'Kroasia', iso2: 'HR', dial: '385' },
  { name: 'Kuba', iso2: 'CU', dial: '53' },
  ...
  { name: 'Luksemburg', iso2: 'LU', dial: '352' },
  { name: 'Madagaskar', iso2: 'MG', dial: '261' },
  { name: 'Makedonia Utara', iso2: 'MK', dial: '389' },
  { name: 'Maladewa', iso2: 'MV', dial: '960' },
  { name: 'Malawi', iso2: 'MW', dial: '265' },
  { name: 'Mali', iso2: 'ML', dial: '223' },
  { name: 'Malta', iso2: 'MT', dial: '356' },
  { name: 'Maroko', iso2: 'MA', dial: '212' },
  { name: 'Mauritania', iso2: 'MR', dial: '222' },
  { name: 'Mauritius', iso2: 'MU', dial: '230' },
  { name: 'Meksiko', iso2: 'MX', dial: '52' },
  { name: 'Mesir', iso2: 'EG', dial: '20' },
  ...
  { name: 'Trinidad dan Tobago', iso2: 'TT', dial: '1868' },
  { name: 'Tunisia', iso2: 'TN', dial: '216' },
  { name: 'Turki', iso2: 'TR', dial: '90' },
  { name: 'Turkmenistan', iso2: 'TM', dial: '993' },
  { name: 'Uganda', iso2: 'UG', dial: '256' },
  { name: 'Ukraina', iso2: 'UA', dial: '380' },
  { name: 'Uni Emirat Arab', iso2: 'AE', dial: '971' },
  { name: 'Uruguay', iso2: 'UY', dial: '598' },
  { name: 'Uzbekistan', iso2: 'UZ', dial: '998' },
  { name: 'Vanuatu', iso2: 'VU', dial: '678' },
  { name: 'Venezuela', iso2: 'VE', dial: '58' },
  { name: 'Yaman', iso2: 'YE', dial: '967' },
  { name: 'Yordania', iso2: 'JO', dial: '962' },
  { name: 'Yunani', iso2: 'GR', dial: '30' },
