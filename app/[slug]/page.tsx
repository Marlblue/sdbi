    ...
    <>
      ...
      <main className="bg-white">
        ...
        <div className="bg-[#0A1E3F] pt-10 pb-8 md:pt-14 md:pb-10">
          <AnimateOnScroll animation="fade-in-up" duration={700} className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Featured image */}
        <AnimateOnScroll animation="scale-in" delay={200} duration={700} className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 relative z-10">
        ...
        {/* Content */}
        <AnimateOnScroll animation="fade-in-up" delay={300} duration={700} as="article" className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div
          ...
          <div className="bg-gray-50 py-16">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {fallbackRelated.map((a, index) => (
                  <AnimateOnScroll key={a.slug} animation="fade-in-up" delay={index * 120} duration={600}>
